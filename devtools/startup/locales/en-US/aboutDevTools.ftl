...
enable-title = Enable Cliqz Developer Tools
enable-inspect-element-title = Enable Cliqz Developer Tools to use Inspect Element
enable-inspect-element-message = Examine and edit HTML and CSS with the Developer Tools’ Inspector.
enable-about-debugging-message = Develop and debug WebExtensions, web workers, service workers and more with Cliqz Developer Tools.
...
enable-common-message = Cliqz Developer Tools are disabled by default to give you more control over your browser.
...
welcome-title = Welcome to Cliqz Developer Tools!
...
footer-title = Cliqz Developer Edition
