properties([
    parameters([
        ...
        string(name: 'PGOProfiles', defaultValue: 'http://kria.cliqz:8080/ipfs/QmYnqK25y7uy6i6p1HLyyaee4Q1ZqYpJbxX3oD546fEhri/85.0', description: 'Base URL for fetching PGO Profiles'),
