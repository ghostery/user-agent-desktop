properties([
    parameters([
        ...
        string(name: 'PGOProfiles', defaultValue: 'http://kria.cliqz:8080/ipfs/QmcKRVZK8bPvZ9NTAPaZ4gkrND2QpZ6jnP9qwDTJhxqLG4/83.0', description: 'Base URL for fetching PGO Profiles'),
