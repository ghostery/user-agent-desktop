properties([
    parameters([
        ...
        string(name: 'PGOProfiles', defaultValue: 'http://kria.cliqz:8080/ipfs/QmNRRytQ9vqHp3yHwfVmYHQRqWE1ie9nV1eiszbxwYwbyK/82.0.2', description: 'Base URL for fetching PGO Profiles'),
