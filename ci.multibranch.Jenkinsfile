properties([
    parameters([
        ...
        string(name: 'PGOProfiles', defaultValue: 'http://kria.cliqz:8080/ipfs/QmTSWFyyTADdQ2YWF9RDQmnFVAfDD5vcS9DS9BjbEkkaWj/84.0.1', description: 'Base URL for fetching PGO Profiles'),
