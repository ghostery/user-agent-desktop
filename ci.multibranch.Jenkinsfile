properties([
    parameters([
        ...
        string(name: 'PGOProfiles', defaultValue: 'http://kria.cliqz:8080/ipfs/Qmck8DuXEYgLakwKCux9yNn2CLpnWWkgAmtceewWuyn3id/85.0', description: 'Base URL for fetching PGO Profiles'),
