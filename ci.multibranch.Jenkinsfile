properties([
    parameters([
        ...
        string(name: 'PGOProfiles', defaultValue: 'http://kria.cliqz:8080/ipfs/QmXCSpgk3QMCf229eYpPva22EASeTLAvoWby23LW8MSJ1Z/86.0', description: 'Base URL for fetching PGO Profiles'),
