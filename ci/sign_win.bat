...
cd ..
copy /b ..\mozilla-release\other-licenses\7zstub\firefox\7zSD.Win32.sfx + browser\installer\windows\instgen\stub.tag + pkg%STUB_PREFIX%_%lang%\stub.7z dist\install\sea\%APP_NAME%-%ff_exe%.%platform_prefix%.installer-stub.exe
