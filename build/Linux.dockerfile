...
RUN wget -nv -O /builds/worker/fetches/rustc.tar.zst https://ghostery-user-agent-cache-public.s3.amazonaws.com/toolchains/123.0/linux64-rust-1.75/rustc.tar.zst && \
    cd /builds/worker/fetches/ && \
...
RUN wget -nv -O /builds/worker/fetches/pkgconf.tar.zst https://ghostery-user-agent-cache-public.s3.amazonaws.com/toolchains/123.0/linux64-pkgconf/pkgconf.tar.zst && \
    cd /builds/worker/fetches/ && \
